...
func (v ValidationError) Error() string {
	return fmt.Sprintf("%s: %v '%v' ### %s ###", v.Field, ValueOf(v.Type), v.BadValue, v.Message)
}
...
// NewFieldInvalid returns a ValidationError indicating "invalid value"
func NewFieldInvalidMessage(field string, value interface{}, message string) ValidationError {
	return ValidationError{ValidationErrorTypeInvalid, field, value, message}
}
